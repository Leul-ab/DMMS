...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('booking_verification_notifications', function (Blueprint $table) {
            ...
            $table->string('payment_attempt_reference')->nullable()->after('payment_account');
            ...
            $table->unique('payment_attempt_reference', 'booking_verification_attempt_ref_unique');
        });
    }
    ...
    {
        Schema::table('booking_verification_notifications', function (Blueprint $table) {
            $table->dropUnique('booking_verification_attempt_ref_unique');
            $table->dropColumn([
                'payment_account',

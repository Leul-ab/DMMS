        ...
        <div className="flex flex-col items-center">
            ...
            <div className="mt-6 grid w-full gap-2">
                {data.map((item, index) => (
                    <div
                        key={item.name}
                        className="flex items-center justify-between rounded-xl border border-orange-100/80 bg-white px-4 py-2.5 transition hover:border-orange-200 hover:shadow-sm"
                    >

        ...
        router.post(
            ...
            },
            {
                ...
                onSuccess: () => {
                    ...
                    toast.success(
                        'Thank you for your feedback! Your overall service rating has been submitted successfully.',
                    );
                },
                onError: (errors) => {
                    setIsSubmitting(false);
                ...
                <main className="mx-auto max-w-2xl px-5 py-10">
                    ...
                    <div className="mb-8 text-center">
                        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-red-50">
                            <Star className="h-8 w-8 fill-red-400 text-red-400" />
                        </div>
                    ...
                    <div className="space-y-6 rounded-3xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
                        ...
                        <div className="flex flex-col items-center gap-4 rounded-2xl border border-red-100 bg-red-50/50 p-6">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full rounded-xl border border-stone-200 bg-white px-4 py-3 text-sm transition outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100"
                            />
                        </div>

                        {/* Anonymous */}
                        <label className="flex cursor-pointer items-center gap-3 rounded-xl border border-stone-200 bg-white p-4 transition hover:border-red-200">
                            <input
                                type="checkbox"
                                checked={anonymous}
                        ...
                        <button
                            ...
                            className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-red-500 to-red-600 px-6 py-4 font-black text-white shadow-lg shadow-red-500/25 transition hover:from-red-600 hover:to-red-700 hover:shadow-xl hover:shadow-red-500/40 active:scale-[0.98] disabled:opacity-60"
                        >
                            {isSubmitting ? (

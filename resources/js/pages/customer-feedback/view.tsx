                ...
                <main className="mx-auto max-w-2xl px-5 py-10">
                    ...
                    <div className="space-y-6 rounded-3xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8">
                        ...
                        <div className="flex flex-col items-center gap-3 rounded-2xl border border-amber-100 bg-amber-50/50 p-6 text-center">
                            ...
                            <StarRating value={feedback.overall_rating} readOnly size="lg" />
                        ...
                        <div className="flex items-center gap-3 rounded-2xl border border-stone-100 bg-stone-50 p-4">
                            ...
                            <div>
                                ...
                                <p className="flex items-center gap-1 text-xs text-gray-500">
                                    ...
                                    Submitted On: {formatDateTime(feedback.created_at)}
                                </p>
                            </div>
                        </div>
                        ...
                        <Link
                            ...
                            className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-4 font-black text-white shadow-lg shadow-orange-500/25 transition hover:from-orange-600 hover:to-orange-700 hover:shadow-xl hover:shadow-orange-500/40 active:scale-[0.98]"
                        >

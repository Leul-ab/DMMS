...
export default function PaymentsIndex({
    ...
    const navigateToFilter = (
        ...
        if (route) {
            ...
            router.get('/admin/payments/orders', cleaned, {
                preserveState: true,
            });
        }
    };
        ...
        router.patch(
            ...
            },
            {
                ...
                onSuccess: () => {
                    ...
                    toast.success(
                        `Payment marked as ${paymentStatusLabels[statusAction] || statusAction}`,
                    );
                    setIsLoading(false);
                },
                onError: () => {
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {statCards.map((card) => (
                        <Card
                            ...
                            onClick={() =>
                                navigateToFilter(card.filterParams, card.route)
                            }
                        >
                            <CardContent className="flex items-center gap-4 p-6">
                                <div
                                    className={`rounded-full ${card.bgColor} p-3 ${card.iconColor}`}
                                >
                                    {card.icon}
                                </div>
                                <div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="rounded-lg bg-gray-50 p-3">
                                    ...
                                    <p className="mt-1 font-bold">
                                        {selectedOrder.payment?.cashier?.name ||
                                            '—'}
                                    </p>
                                </div>
                                <div className="rounded-lg bg-gray-50 p-3">
                        ...
                        <div className="space-y-4 py-4">
                            <div className="rounded-lg bg-gray-50 p-4">
                                <p className="text-sm text-gray-600">
                                    ...
                                    <Badge
                                        className={
                                            paymentStatusColors[statusAction]
                                        }
                                    >
                                        {paymentStatusLabels[statusAction] ||
                                            statusAction}
                                    </Badge>
                                </p>
                            </div>
